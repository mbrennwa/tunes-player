...
class VisibleArtIndicesTests(unittest.TestCase):
    ...
    def test_mid_scroll(self) -> None:
        edge = 140
        stride = edge + RELEASE_GRID_SPACING
        margin = RELEASE_GRID_VIEW_MARGIN
    ...
    def test_prefetch_expands_range(self) -> None:
        without = release_grid_visible_card_indices(
            card_count=30,
            columns=3,
            tile_edge=140,
            scroll_y=0,
        ...
        with_prefetch = release_grid_visible_card_indices(
            card_count=30,
            columns=3,
            tile_edge=140,
            scroll_y=0,
