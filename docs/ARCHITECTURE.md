...
3. DEB package with declared depends (`python3-gi`, `gir1.2-adw-1`, `mpv`, …).
4. One streaming backend (Tidal or Qobuz).
5. Federated catalog search (phase A).
6. Heuristic dedup / prefer-local.
7. Optional Qt UI for macOS.
